<h2><a href="https://leetcode.com/problems/fruits-into-baskets-iii/editorial/?envType=daily-question&envId=2025-08-06">3479. Fruits Into Baskets III</a></h2><h3>Medium</h3><hr><p>You are given two arrays of integers, <code>fruits</code> and <code>baskets</code>, each of length <code>n</code>, where <code>fruits[i]</code> represents the <strong>quantity</strong> of the <code>i<sup>th</sup></code> type of fruit, and <code>baskets[j]</code> represents the <strong>capacity</strong> of the <code>j<sup>th</sup></code> basket.</p>
